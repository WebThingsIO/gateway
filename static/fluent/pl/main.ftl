...
settings-authorizations = Autoryzacje
...
notification-normal = Normalny
notification-high = Wysoki
rule-name = Nazwa Reguły
rule-and = i
rule-or = lub
rule-time-of-day-is = jest godzina
rule-event-lower = zdarzenie
...
logs-retention-length = Czas Retencji
  .aria-label = Rejestrowany Czas Retencji
logs-retention-unit =
  .aria-label = Rejestrowana Jednostka Retencji
logs-hours = Godziny
logs-days = Dni
logs-weeks = Tygodnie
logs-save = Zapisz
