...
add-thing-add-adapters-hint = Gjin apparaten fûn. Probearje
add-thing-add-adapters-hint-anchor = add-ons ta te foegjen
...
local-token-use-it = Brûk dizze om befeilige mei de gateway te praten, mei
