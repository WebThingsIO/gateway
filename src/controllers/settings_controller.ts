...
export default function SettingsController(): express.Router {
  const router = express.Router();
  /**
 * Set an experiment setting.
 */
  router.put('/experiments/:experimentName', auth, async (request, response) => {
 ...
 */
  router.get('/experiments/:experimentName', auth, async (request, response) => {
    const experimentName = request.params.experimentName;
  ...
  router.post('/reclaim', async (request, response) => {
  ...
  router.post('/skiptunnel', async (_request, response) => {
    try {
  ...
  router.get('/tunnelinfo', auth, async (_request, response) => {
    try {
 ...
 *            }
 */
  router.put('/domain', auth, async (request, response) => {
  ...
  router.get('/addonsInfo', auth, (_request, response) => {
    response.json({
  ...
  router.get('/system/platform', auth, (_request, response) => {
    response.json({
      architecture: Platform.getArchitecture(),
      os: Platform.getOS(),
    });
  ...
  router.get('/system/ssh', auth, (_request, response) => {
  ...
  router.put('/system/ssh', auth, (request, response) => {
    if (!request.body || !request.body.hasOwnProperty('enabled')) {
      response.status(400).send('Enabled property not defined');
      return;
    }
  ...
  router.post('/system/actions', auth, (request, response) => {
  ...
  router.get('/system/ntp', (_request, response) => {
  ...
  router.post('/system/ntp', (_request, response) => {
  ...
  router.get('/network/dhcp', auth, (_request, response) => {
  ...
  router.put('/network/dhcp', auth, (request, response) => {
    if (!request.body || !request.body.hasOwnProperty('enabled')) {
  ...
  router.get('/network/lan', auth, (_request, response) => {
  ...
  router.put('/network/lan', auth, (request, response) => {
  ...
  router.get('/network/wireless', auth, (_request, response) => {
  ...
  router.get('/network/wireless/networks', auth, (_request, response) => {
  ...
  router.put('/network/wireless', auth, (request, response) => {
    if (!request.body || !request.body.hasOwnProperty('enabled')) {
      response.status(400).send('Missing enabled property');
      return;
    }
  ...
  router.get('/network/addresses', auth, (_request, response) => {
  ...
  router.get('/localization/country', auth, (_request, response) => {
    let valid = [];
  ...
  router.put('/localization/country', auth, (request, response) => {
  ...
  router.get('/localization/timezone', auth, (_request, response) => {
    let valid = [];
  ...
  router.put('/localization/timezone', auth, (request, response) => {
  ...
  router.get('/localization/language', auth, async (_request, response) => {
  ...
  router.put('/localization/language', auth, async (request, response) => {
  ...
  router.get('/localization/units', auth, async (_request, response) => {
    let temperature;
  ...
  router.put('/localization/units', auth, async (request, response) => {
