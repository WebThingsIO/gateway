...
export default function ThingsController(): express.Router {
 ...
 */
  router.use(`/:thingId${Constants.ACTIONS_PATH}`, ActionsController());

  /**
 * Use an EventsController to handle each thing's events.
 */
  router.use(`/:thingId${Constants.EVENTS_PATH}`, EventsController());
