...
export default function NewThingsController(addonManager: AddonManager): express.Router {
 ...
 */
  router.get('/', (_request, response) => {
    addonManager.getThingsCollection().getNewThings().then((newThings: any) => {
 ...
 */
  ...
  // possibility that the WebSocket have been closed.
    ...
    addonManager.getThingsCollection().registerWebsocket(websocket);
